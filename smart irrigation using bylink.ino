...
#include <DHT.h>
#define BLYNK_TEMPLATE_ID "TMPL7IUlfVUi"
#define BLYNK_TEMPLATE_NAME "Smart Plant"
#define BLYNK_AUTH_TOKEN "YGr9cAJIBnno9iDAdqwxN2ez6Hy7aciu"

//Initialize the LCD display
LiquidCrystal_I2C lcd(0x3F, 16, 2);


char auth[] = "YGr9cAJIBnno9iDAdqwxN2ez6Hy7aciu";  //Enter your Blynk Auth token"; 
char ssid[] = "Root"; //Enter your WIFI SSID
char pass[] = "11111112";  //Enter your WIFI Password
